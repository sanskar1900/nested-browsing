...
const Folder = ({ interactive, setCopiedNode, folderData, setBreadCrumb, index, breadcrumb, folderTree, setFolderTree }) => {
    ...
    return (
        <>
            <div className="folder root" onDoubleClick={alterBreadCrumb} onClick={alterMenuVisibility}>
                ...
                {showMenu && <Menu setCopiedNode={setCopiedNode} setOpenModal={setOpenModal} setShowMenu={setShowMenu} folderData={folderData} breadcrumb={breadcrumb} folderTree={folderTree} setFolderTree={setFolderTree} />}
